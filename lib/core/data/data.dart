/// Data models + static mock database used in the application.
class StoryData {
  final int id;
  final String name;
...
/// ---------------------------------------------------------------------------
/// App Database – Mock Data Provider
/// ---------------------------------------------------------------------------
class AppDatabase {
  ...
  static List<PostData> get posts {
    return [
      PostData(
        id: 1,
        title: 'Exploring machines that mimic human intelligence',
        caption: 'Robotic Wonders',
        isBookmarked: false,
        likes: '3.1k',
        time: '1hr ago',
      ...
      PostData(
        id: 0,
        title: 'Keep your online presence safe and private',
        caption: 'Guard Your Online World',
        isBookmarked: false,
        likes: '1.2k',
        time: '2hr ago',
      ...
      PostData(
        id: 2,
        title: 'Discover the newest tech powering tomorrow',
        caption: 'Modern Computing Trends',
        isBookmarked: true,
        likes: '2k',
        time: '41hr ago',
